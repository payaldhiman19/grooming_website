...
const Login = ({ onClose, onLoginSuccess }) => {
  ...
  const [activeTab, setActiveTab] = useState('login'); // login | signup | adminLogin
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError('');
        setSignupSuccess('Account created successfully. Please log in to continue.');
        setActiveTab('login');
      } else {
    ...
    <div className="login-container">
      <div className="form-container">
        ...
        <div className="auth-header">
          <h2 className="auth-title">Welcome back to Clesa</h2>
          <p className="auth-subtitle">
            Sign in to continue, or create a new account in just a minute.
          </p>
        </div>
