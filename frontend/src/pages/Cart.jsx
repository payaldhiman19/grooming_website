    ...
    <>
      ...
      {cart.length > 0 && (
        <p className="cart-subtitle">
          You have {cart.length} item{cart.length > 1 ? 's' : ''} in your bag. Review your favourites and proceed to a secure checkout.
        </p>
      )}
      <div className="cart-page">
        {cart.length === 0 ? (
          <div className="empty-cart">
            <h4>Your cart feels a little empty</h4>
            <p>Add a few Clesa favourites to see them here and complete your routine.</p>
            <Link to="/Skincare" className="empty-cart-btn">
              Browse products
            </Link>
          </div>
        ) : (
              ...
              <div key={index} className="cart-item">
                ...
                <div className="product-info">
                  ...
                  <span className="product-description">
                    {product.product_description || 'Perfect daily care picked from your Clesa routine.'}
                  </span>
